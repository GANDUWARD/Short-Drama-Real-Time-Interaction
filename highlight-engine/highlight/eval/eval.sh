...
DIR="yourpath/projects/highlight-engine"
MODEL_DIR="yourpath/highlight_vllava/sft_v3_128_v4_sep_final_v5"
# MODEL_DIR="highlight_vllava/stage1_v4/"
# MODEL_DIR="highlight_vllava/stage2_sft_v3_64/checkpoint-600"
...
# DATASET='activitynet'
# SPLIT='test'
# PROMPT_FILE="projects/highlight-engine/highlight/prompts/dvc-anet.txt"
...
# DATASET='charades'
# SPLIT='test'
# PROMPT_FILE="projects/highlight-engine/highlight/prompts/mr.txt"
# GT_FILE="${ANNO_DIR}/${SPLIT}.caption_coco_format.json"
...
NUM_FRAME=128
OUTPUT_DIR=${DIR}/eval_results/${TASK}_highlight_embed_128
CFG_PATH=""


CUDA_VISIBLE_DEVICES=0 python yourpath/projects/highlight-engine/highlight/eval/evaluate.py --anno_path ${ANNO_DIR} --video_path ${VIDEO_DIR} --gpu_id 0 \
...
python yourpath/projects/highlight-engine/highlight/eval/reformat_${TASK}.py --pred_file "${OUTPUT_DIR}/fmt_${DATASET}_${SPLIT}_f${NUM_FRAME}_result.json" --out_file "${OUTPUT_DIR}/refmt_${DATASET}_${SPLIT}_f${NUM_FRAME}_result.json"

cd yourpath/projects/highlight-engine/highlight/metrics/${TASK}
...
# cd projects/highlight-engine/highlight/metrics/${TASK}
