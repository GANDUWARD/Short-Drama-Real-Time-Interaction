...
from .model import HighlightMistralForCausalLM
...
def model_init(model_path=None):
    model_path = "DAMO-NLP-SG/highlight-7B" if model_path is None else model_path
...
def infer(model, video, instruct, tokenizer, do_sample=False):
    """Inference API for highlight for video understanding.
