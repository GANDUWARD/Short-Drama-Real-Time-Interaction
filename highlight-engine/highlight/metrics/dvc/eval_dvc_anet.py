...
sys.path.append('/cfs/cfs-lugcocyb/yongxinguo/projects/project_temporal_video_understanding/metrics')
sys.path.append('/cfs/cfs-lugcocyb/yongxinguo/projects/project_temporal_video_understanding/metrics/dvc')
sys.path.append('/cfs/cfs-lugcocyb/yongxinguo/projects/project_temporal_video_understanding/metrics/dvc/SODA')
...
if __name__ == '__main__':
    data_path = "/cfs/cfs-lugcocyb/yongxinguo/projects/VTG-LLM/eval_results/dvc/dvc_videollama_slot_fm96_fmt_e9_fmt_interpolate/fmt_activitynet_test_f96_result.json"
    gt_file = '/cfs/cfs-lugcocyb/yongxinguo/data/TimeIT/data/dense_video_captioning/anet/val_2.json'
    ...
    # print([len(v) for k, v in new_data.items()])

    gt_data = {k: v for k, v in gt_data.items() if k in new_data.keys()}

    pred_result = {'results': new_data}

    metrics = eval_soda(pred_result, [gt_data])
#     metrics = {}
    metrics.update(eval_dvc(pred_result, [gt_data], 
