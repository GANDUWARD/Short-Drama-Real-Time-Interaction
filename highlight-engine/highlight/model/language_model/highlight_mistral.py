...
from ..highlight_arch import HighlightMetaModel, HighlightMetaForCausalLM
...
class HighlightMistralConfig(MistralConfig):
    model_type = "highlight_mistral"


class HighlightMistralModel(HighlightMetaModel, MistralModel):
    config_class = HighlightMistralConfig

    def __init__(self, config: MistralConfig):
        super(HighlightMistralModel, self).__init__(config)


class HighlightMistralForCausalLM(MistralForCausalLM, HighlightMetaForCausalLM):
    config_class = HighlightMistralConfig
    ...
    def __init__(self, config, **kwargs):
        ...
        self.model = HighlightMistralModel(config)
...
AutoConfig.register("highlight_mistral", HighlightMistralConfig)
AutoModelForCausalLM.register(HighlightMistralConfig, HighlightMistralForCausalLM)
