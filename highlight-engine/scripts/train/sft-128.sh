...
export WANDB_PROJECT=highlight_vllava
export NCCL_P2P_LEVEL=NVL
export HCCL_BUFFSIZE=1024
RUN_NAME=highlight_vllava
DATA_DIR=datasets
OUTP_DIR=yourpath/
...
ASCEND_LAUNCH_BLOCKING=1 torchrun --nnodes $WORLD_SIZE \
    ...
    --node_rank $RANK \
    yourpath/projects/highlight-engine/highlight/train_mt_npu.py \
    --deepspeed yourpath/projects/highlight-engine/scripts/zero3.json \
    --version v1_mistral \
    ...
    --model_name_or_path yourpath/highlight_vllava/stage1_128 \
