...
print(sys.path)
from highlight.conversation import conv_templates, SeparatorStyle
from highlight.constants import DEFAULT_MMODAL_TOKEN, MMODAL_TOKEN_INDEX
from highlight.mm_utils import get_model_name_from_path, tokenizer_MMODAL_token_all, process_video, process_image, KeywordsStoppingCriteria
from highlight.model.builder import load_pretrained_model


def inference():
    # Video Inference
    paths = [str(REPO_ROOT / 'assets' / 'cat_and_chicken.mp4')]
